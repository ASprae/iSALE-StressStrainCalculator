...
print ("Reading Tracer List input")
print ("===================================")
print ("{}".format(tracerlist))
print ("===================================")
...
#    print (".................")
    ...
    print ("SCRIPT HAS FINISHED A TRACER - STRESS AND STRAIN DATA ARE NOW OUTPUT TO A .txt FILE, LOCATED IN THE USER-SPECIFIED OUTPUT DIRECTORY")
